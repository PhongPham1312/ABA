...
class CamManage extends Component {
                ...
                <div className='user-container-ss2'>
                    ...
                    <div className='user-container kho-container'>
                        <ul>
                            ...
                            <li onClick={() => this.gotolink(`kho-xac-mount/${this.props.match.params?.id}`)} >XÁC</li>
                            <li className={url === true ? 'li1' : ''}>CẦM</li>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CamManage));
