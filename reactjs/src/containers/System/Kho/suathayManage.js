...
class SuaThayManage extends Component {
    ...
    render() {
        ...
        let url = this.kiemTraChuoi(this.props.match?.url, 'kho-sua-thay-mount' ) ? true : false;
        return (
                ...
                <div className='user-container-ss2'>
                    ...
                    <div className='user-container kho-container'>
                        <ul>
                            ...
                            <li className={url === true ? 'li1' : ''}>SỬA , THAY</li>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SuaThayManage));
